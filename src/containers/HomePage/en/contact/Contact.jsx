...
export default function Contact() {
  return (
    <section id="contact" className="ui-wrapper py-16 md:py-32">
      <SlideUp>
        <h2 className="ui-tagline">Contakt</h2>
      ...
      <div className="mt-32 grid grid-cols-1 gap-16 md:grid-cols-3">
        <SlideUp className="col-span-2">
          <h3 className="ui-heading">Have a question?</h3>
          <div className="pt-6">
            <ContactForm />
          </div>
        </SlideUp>
        ...
        <SlideUp className="col-span-1">
          <h4 className="ui-heading">Billing information</h4>
          <p className="pt-6">
            ...
            account no.: 123-1828880217/0100 <br />
            IBAN: CZ29 0100 0001 2318 2888 0217 <br />
            BIC/SWIFT = KOMBCZPPXXX <br />
            <br />
            The sole proprietorship acts in accordance with the Trade Licensing
            Act and is not entered in the commercial register
          </p>
        </SlideUp>
      </div>
    </section>
