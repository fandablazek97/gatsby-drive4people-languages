    ...
    >
      <div className="ui-wrapper">
        <div className="grid grid-cols-1 gap-16 md:grid-cols-2">
          <SlideUp>
            <h2 className="ui-tagline text-gray-300">Car fleet</h2>
          ...
          <SlideUp className="md:reveal-delay-300">
            <h3 className="ui-heading text-primary">
              A car is always perfectly prepared for you
            </h3>
            <ul className="ml-8 list-disc text-gray-300">
              <li>
                A car is fully equipped with an automatic transmission for your
                comfort
              </li>
              <li>
                A car is spacious and comfortable whether you drive alone or
                with more people
              </li>
              <li>Loading a large luggage is not a big deal</li>
              <li>
                In car – Wi-Fi, Refreshments, Device charging, Newspappers,
                Comfort
              </li>
            </ul>
          </SlideUp>
